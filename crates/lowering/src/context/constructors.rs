...
impl<'a> Lowering<'a> {
    ...
    pub fn new_with_capacity(
        ...
        // Estimate typical variable count per function
        ...
        Self {
            ...
            next_local_id: 0,
            next_block_id: 0,
            // Per-function maps (cleared per function, but pre-allocate for typical usage)
            var_to_local: IndexMap::with_capacity(estimated_vars),
            var_types: IndexMap::with_capacity(estimated_vars),
            current_blocks: Vec::with_capacity(16), // Typical function has ~16 blocks
            current_block_idx: 0,
            // Module-level maps (sized based on module)
            func_name_map: IndexMap::with_capacity(func_count),
            loop_stack: Vec::with_capacity(4), // Max nesting depth
            class_info: IndexMap::with_capacity(class_count),
            class_name_map: IndexMap::with_capacity(class_count),
            // Function reference maps
            ...
            // Cross-module maps (small default, replaced via setters)
    ...
    pub fn set_module_var_exports(&mut self, exports: HashMap<(String, String), (VarId, Type)>) {
        self.module_var_exports = exports;
    }
    ...
    pub fn set_module_func_exports(&mut self, exports: HashMap<(String, String), Type>) {
        self.module_func_exports = exports;
    }
    ...
    pub fn set_module_class_exports(
        ...
        self.module_class_exports = exports;
    }
    ...
    pub fn register_imported_function(&mut self, name: String, func_id: FuncId) {
        self.func_name_map.insert(name, func_id);
    }
